...
def uploadFile(path, bucket_name):
...
def main():
    ...
    #print('Finished loop successfully. Goodbye!')# Update and publish temperature readings at a rate of one per second.
    for i in range(1,3):
        ...
        # as a JSON string.
        payload = json.dumps({'temperature': i})
...
if __name__ == '__main__':
    ...
    #public_url = uploadFile('cam.jpg', 'iotpractice')
    #create_topic("iot-practice-223905", "camera_survillence")
    #list_topics("iot-practice-223905")
    #print(upload_image_file(getFile("/home/pi/cam.jpg")))
    #publish_messages("iot-practice-223905", "light", public_url)
